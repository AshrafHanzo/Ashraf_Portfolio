...
import ComicOverlay from "@/components/storytelling/ComicOverlay";
...
const Index = () => {
  ...
  // Scroll to top on page load/refresh and track visitor
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Comic-book atmosphere: spider webs + halftone (shown after load) */}
      {hasLoadedOnce && <ComicOverlay />}
