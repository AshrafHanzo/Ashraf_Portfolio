...
const quotes = [
    ...
    "Every system deserves to run flawlessly...",
    "Every problem is waiting to be caught...",
    "Let's swing into it.",
];
                ...
                >
                    ...
                    <div className="relative z-10 max-w-4xl px-8 text-center">
                        ...
                        >
                            ...
                            >
                                <span className="text-3xl font-bold text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">🕷️</span>
                            </motion.div>
                        </motion.div>
