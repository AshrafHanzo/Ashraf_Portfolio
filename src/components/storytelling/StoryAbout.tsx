...
const StoryAbout = () => {
  ...
  const topSkills = [
    { name: "AI & Browser Automation", percentage: 95, color: "#e11d2a" },
    { name: "Full-Stack (FastAPI + React)", percentage: 92, color: "#2b6ce6" },
    { name: "Real-Time & DevOps", percentage: 88, color: "#e11d2a" },
  ];
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-6 mb-8 text-center md:text-left">
                ...
                >
                  <div className="w-full h-full rounded-full md:rounded-xl bg-gradient-to-b from-primary/25 via-background to-accent/25 flex items-center justify-center overflow-hidden">
                    <img
