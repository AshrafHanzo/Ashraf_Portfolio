...
const StorySkills = () => {
  ...
  // Calculate age based on birthdate (adjust to your real DOB)
  const birthDate = new Date(2004, 0, 1); // Month is 0-indexed, so 0 = January
          ...
          <div className="glass-card p-6 mb-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-display text-xl font-bold text-foreground">AI Automation Engineer</h3>
