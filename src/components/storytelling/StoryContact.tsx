...
// Messages are delivered to ashrafali.offic@gmail.com via the secure Gmail
// serverless mailer (/api/send-email). See SETUP_ASHRAF.md.
          ...
          >
            ...
            <div className="rounded-3xl overflow-hidden border border-border/50 bg-background shadow-xl">
              ...
              <div className="flex items-center gap-3 p-4 bg-secondary/30 border-b border-border/30">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">Ashraf Ali</h3>
              ...
              <div className="p-4 space-y-4 min-h-[300px] max-h-[400px] overflow-y-auto">
                <ChatMessage
                  isBot
                  message="Hey there! 👋 I'm Ashraf. Thanks for swinging by my portfolio!"
                  delay={0}
                />
                <ChatMessage
                  isBot
                  message="I build production SaaS, AI & browser automation, and full-stack apps. How can I help you today?"
                  delay={300}
                />
